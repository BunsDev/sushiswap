...
import { Form, Input, Select, Typography } from 'soulswap-ui'
...
export const GradedVestingDetailsSection = () => {
  ...
  const { data: balance } = useBalance({ account: address, chainId: currency?.chainId, currency, loadCoffinbox: true })
