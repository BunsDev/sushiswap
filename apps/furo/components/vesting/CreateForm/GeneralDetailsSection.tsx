...
import { classNames, DEFAULT_INPUT_BG, Form, Input, Select, Typography } from 'soulswap-ui'
import { TokenSelector, useBalance, Web3Input } from 'soulswap-wagmi'
...
export const GeneralDetailsSection = () => {
  ...
  const { data: balance } = useBalance({ account: address, chainId: activeChain?.id, currency, loadCoffinbox: true })

  return (
    <Form.Section
      title="General Details"
      description="Furo allows for creating a vested stream using your CoffinBox balance."
    >
