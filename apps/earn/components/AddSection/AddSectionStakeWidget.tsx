...
import { Amount, Token, tryParseAmount, Type } from 'soulswap-currency'
import { formatUSD } from 'soulswap-format'
import { FundSource } from 'soulswap-hooks'
import { Button, classNames, Currency, DEFAULT_INPUT_UNSTYLED, Input, Typography } from 'soulswap-ui'
import { Widget } from 'soulswap-ui/widget'
import { useTotalSupply } from 'soulswap-wagmi'
