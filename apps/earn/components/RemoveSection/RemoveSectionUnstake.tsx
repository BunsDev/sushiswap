import { Amount, Token, tryParseAmount } from 'soulswap-currency'
import { Pair } from 'soulswap-graph-client/.graphclient'
import { useIsMounted } from 'soulswap-hooks'
import { AppearOnMount, Button, Dots, Typography } from 'soulswap-ui'
import { Approve, Checker, Chef, getMasterChefContractConfig } from 'soulswap-wagmi'
