...
import { ComplexRewarderTime, MiniChefV2 } from 'soulswap-core'
import ComplexRewarderTimeABI from 'soulswap-core/abi/ComplexRewarderTime.json'
import MiniChefV2ABI from 'soulswap-core/abi/MiniChefV2.json'
import { MINICHEF_SUBGRAPH_NAME, SUBGRAPH_HOST } from 'soulswap-graph-config'
