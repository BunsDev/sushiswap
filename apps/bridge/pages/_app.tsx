...
const MyApp: FC<AppProps> = ({ Component, pageProps }) => {
  ...
  return (
    <>
      <Head>
        <link rel="apple-touch-icon" sizes="180x180" href="/bridge/apple-touch-icon.png?v=1" />
        <link rel="icon" type="image/png" sizes="32x32" href="/bridge/favicon-32x32.png?v=1" />
        <link rel="icon" type="image/png" sizes="16x16" href="/bridge/favicon-16x16.png?v=1" />
