...
export const KASHI_SUBGRAPH_HOST = {
...
export const KASHI_SUBGRAPH_NAME = {
  [ChainId.ETHEREUM]: 'matthewlilley/kashi-ethereum',
  [ChainId.POLYGON]: 'matthewlilley/kashi-polygon',
  [ChainId.GNOSIS]: 'matthewlilley/kashi-gnosis',
  [ChainId.AVALANCHE]: 'matthewlilley/kashi-avalanche',
  [ChainId.ARBITRUM]: 'matthewlilley/kashi-arbitrum',
  [ChainId.BSC]: 'matthewlilley/kashi-bsc',
} as const
