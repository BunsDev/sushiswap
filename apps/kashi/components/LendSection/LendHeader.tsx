...
interface LendHeader {
  pair: KashiMediumRiskLendingPairV1
}

export const LendHeader: FC<LendHeader> = ({ pair }) => {
          ...
          <div className="flex items-center">
            ...
            <div className="flex flex-col">
              <div className="flex items-center gap-2">
                ...
                <Chip color="gray" label={`${pair.supplyAPR.toFixed(2)}%`} className="font-medium text-slate-50" />
              </div>
          ...
          <div className="flex flex-col gap-1">
            ...
            <div className="flex gap-3 rounded-lg bg-slate-800 px-3 py-1.5">
              ...
              <Typography variant="sm" weight={600} className="text-slate-300">
                1 {asset.symbol} = {pair.assetPrice.toSignificant(6)} {collateral.symbol}
              </Typography>
            </div>
          </div>
        </div>
